...
public class UIConstants {
    ...
    final public static double BUTTON_ICON_WIDTH_RATIO = 0.03; // 按钮宽度
    ...
    final public static int CONTENT_SMALL_FONT_SIZE = 12; // 内容中小字体的大小
    ...
    final public static String PROJECT_DIR = System.getProperty("user.dir"); // 项目目录
    final public static String IMAGE_DIR = fileConcat(PROJECT_DIR, "images"); // 图片目录
}
